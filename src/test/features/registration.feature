...
Feature: registration feature for AutomationPractice site
  ...
  Scenario Outline: verify account creation validation message
    ...
    Examples:
      ...
      | sahisera@gmail.com |           |          | reddy              | sahisunny | 11   | 5     | 1988 | advith           | maryada           | 12 lonsdale rd | Kent   | 4          | 12345      | United States | dresses        | 984667865   | 09974532368 | Same Address | lastname is required.                                                            |